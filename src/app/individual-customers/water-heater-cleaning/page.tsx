    ...
    return (
        <div className="min-h-screen">
            <MainSection
                ...
                description="Dịch vụ vệ sinh máy nóng lạnh của SkyHome mang đến sự tiện lợi và linh hoạt cho khách hàng. Với đội ngũ nhân viên chuyên nghiệp, chúng tôi cam kết cung cấp dịch vụ chất lượng cao, giúp bạn duy trì không gian sống sạch sẽ và thoải mái mà không cần phải lo lắng về việc thuê dài hạn."
                buttonText="Đặt dịch vụ ngay"
                buttonLink="/individual-customers/water-heater-cleaning/service-form"
                imageSrc="/individual-service/vsmaynonglanh.png"
            />
            <ServiceProtected
